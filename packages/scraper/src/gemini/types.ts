...
export const PRODUCT_EXTRACTION_SCHEMA = {
  ...
  items: {
    ...
    properties: {
      ...
      bbox_x: { type: 'INTEGER', description: 'Product bounding box left edge as percentage (0-100) of image width', nullable: true },
      bbox_y: { type: 'INTEGER', description: 'Product bounding box top edge as percentage (0-100) of image height', nullable: true },
      bbox_w: { type: 'INTEGER', description: 'Product bounding box width as percentage (0-100) of image width', nullable: true },
      bbox_h: { type: 'INTEGER', description: 'Product bounding box height as percentage (0-100) of image height', nullable: true },
    },
